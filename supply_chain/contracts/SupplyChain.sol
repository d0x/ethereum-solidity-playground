...
contract SupplyChain {
    ...
    */
    ...
    modifier paidEnough(uint _price) {require(msg.value >= _price);
        _;}
    ...
    modifier received(uint _sku) {require(items[_sku].state == State.Received);
        _;}
    ...
    /* Add 2 modifiers
      👍 to check if the item is sold already,
